...
//ZTE_ZHANGTAO_20100419_01 begin
static const unsigned short keypad_keymap_mooncake[ARRAY_SIZE(keypad_col_gpios) *
	...
	[KEYMAP_INDEX(0, 1)] = KEY_RESERVED,	//ZTE_KEYPAD_ZFJ_20110114 from KEY_END to KEY_RESERVED
...
static struct gpio_event_platform_data mooncake_keypad_data = {
	.name		= "banana-keypad",  //should with "-keypad" in froyo, ZTE_KEYPAD_LIWEI_20101210
