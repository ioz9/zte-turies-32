...
---------     -------       -------------------------------------------------------     --------------------------
2011-01-05   zfj	  		modify keymap for N700		ZTE_KEY_ZFJ_0105
...
static const unsigned short keypad_keymap_mooncake[ARRAY_SIZE(keypad_col_gpios) *
	...
	/*                       row, col   */
	/*ZTE_KEY_ZFJ_0105 BEGIN*/
	[KEYMAP_INDEX(0, 0)] = KEY_MENU, 
	[KEYMAP_INDEX(0, 1)] = KEY_SEARCH, //not defined
	...
	[KEYMAP_INDEX(1, 3)] = 0,  //not defined 
	/*ZTE_KEY_ZFJ_0105 END*/
};
