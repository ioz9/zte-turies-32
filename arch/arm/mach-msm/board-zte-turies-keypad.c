...
static const unsigned short keypad_keymap_turies[ARRAY_SIZE(keypad_col_gpios) *
	...
	[KEYMAP_INDEX(6, 6)] = KEY_BACK,  //KEY_HOME, // HOME key  on top ,ZTE_KEYPAD_LIWEI_20100916
	...
	[KEYMAP_INDEX(8, 1)] = KEY_BACKSPACE,   //KEY_SYSRQ,   // "?" and  0
	[KEYMAP_INDEX(8, 2)] = KEY_RESERVED,
	[KEYMAP_INDEX(8, 3)] = KEY_SPACE, 
	[KEYMAP_INDEX(8, 4)] = KEY_0,  //KEY_BACK, //RETURN
	[KEYMAP_INDEX(8, 5)] = KEY_COMPOSE,    //symble use tab instead
...
static struct gpio_event_info *turies_keypad_info[] = {
	...
	//&turies_keypad_switch_info.info,	//ZTE_KEYPD_XIAYC_20101026 //ZTE_KEYPAD_ZFJ_20110307
};
