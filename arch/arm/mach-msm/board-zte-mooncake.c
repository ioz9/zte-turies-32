...
//modify bt power for broadcom bluetooth chip  ZTE_BT_QXX_20101025 begin 
...
#endif
//modify bt power for broadcom bluetooth chip  ZTE_BT_QXX_20101025 end 
...
/* ZTE_CAM_ZT_20110215
 * modify IOVDD voltage to 0V for N606 plus lowcost board 
 * that IOVDD is supported by LDO
 */
#ifdef CONFIG_MSM_CAMERA_N600_PLUS_LOWCOST
#define MSM_CAMERA_POWER_BACKEND_IOVDD_VAL      (0)
#else
...
/*ZTE_AUX2_FYA_001,@2010-02-06,END*/
	&smc91x_device,
/*ZTE_TSSC_WLY_001, @2010-04-13,BEGIN*/
#if defined( CONFIG_TOUCHSCREEN_MSM_LEGACY) || defined( CONFIG_TOUCHSCREEN_MSM) || defined( CONFIG_MINI_RACER)
	&msm_device_tssc,
#endif
/*ZTE_TSSC_WLY_001, @2010-04-13,BEGIN*/	
...
#if !defined(CONFIG_MSENSORS_FROM_AUXI2C_TO_I2C) &&  \
		!defined(CONFIG_SENSORS_AKM8962)
	{
		I2C_BOARD_INFO("akm8973", 0x1c),
	},
#endif
