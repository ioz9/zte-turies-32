...
static int gpio_array_num[] = {
				...
				GPIO_LCD_RESET_OUT,
				GPIO_LCD_ID_DETECT,//ZTE_LCD_LKEJ_20110216_001
				};
...
static void lcdc_lead_gpio_init(void)
{
	...
	if (gpio_request(GPIO_LCD_ID_DETECT, "gpio_id_detect"))//ZTE_LCD_LKEJ_20110216_001
...
static uint32_t lcdc_gpio_table[] = {
	...
	GPIO_CFG(GPIO_LCD_ID_DETECT, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),};//ZTE_LCD_LKEJ_20110216_001
#else
static int gpio_array_num[] = {
...
//ZTE_LEDS_XIAYC_20101102
static struct gpio_led android_led_list[] = {
/*ZTE_KEYPAD_ZFJ_20110307 begin*/
#if 1
	{
		.name = "button-backlight",  //(FPC)KP
		.gpio = 57,
	},
#endif
/*ZTE_KEYPAD_ZFJ_20110307 end*/
#if 0
	{
		.name = "keyboard-backlight",  //KP
		.gpio = 57,
	},
#endif
};
...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI
{
		...
		/*.flags        = ,*/
		.addr         = 0x22,
		.irq          = MSM_GPIO_TO_INT(18), //29 //ZTE_TS_ZFJ_20110215
	},
	#endif
...
struct msm_ts_platform_data msm_tssc_pdata ={
	.x_max = 319,  // Match the LCD screen , ZTE_TOUCH_LIWEI_20100911
	.y_max = 479,  // Match the LCD screen , ZTE_TOUCH_LIWEI_20100911
	.pressure_max =255,
};
#elif defined( CONFIG_TOUCHSCREEN_MSM)
struct msm_ts_platform_data msm_tssc_pdata = {
	.min_x = 0,
	.max_x = 319,// Match the LCD screen , ZTE_TOUCH_LIWEI_20100911
	.min_y = 0,
	.max_y = 479,// Match the LCD screen , ZTE_TOUCH_LIWEI_20100911
	.min_press =0,
	.max_press =255,
	.inv_x = 955, // add by liwei , invert the X position, ZTE_TOUCH_LIWEI_20100910
	.inv_y = 955,
};
#endif
...
MACHINE_START(TURIES, "turies ZTE handset")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io        = MSM_DEBUG_UART_PHYS,
	.io_pg_offst    = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
