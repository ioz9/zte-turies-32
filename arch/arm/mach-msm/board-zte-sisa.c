...
#ifdef CONFIG_ZTE_PLATFORM 
//lcd reset & spi 
#define GPIO_TV_1V8_EN		1
#define GPIO_TV_2V5_EN		2
#define GPIO_TV_RST			88
#define GPIO_TV_3V3_EN		97 
#else
...
static int gpio_array_num[] = {
				GPIO_TV_1V8_EN, /* spi_clk */
				GPIO_TV_2V5_EN, /* spi_cs  */
				GPIO_TV_RST, /* spi_sdi */
				GPIO_TV_3V3_EN, /* spi_sdoi */
				};

static void lcdc_lead_gpio_init(void)
{
	if (gpio_request(GPIO_TV_1V8_EN, "TV_1V8_EN"))
		pr_err("failed to request gpio TV_1V8_EN\n");
	if (gpio_request(GPIO_TV_2V5_EN, "TV_2V5_EN"))
		pr_err("failed to request gpio TV_2V5_EN\n");
	if (gpio_request(GPIO_TV_RST, "TV_RST"))
		pr_err("failed to request gpio TV_RST\n");
	if (gpio_request(GPIO_TV_3V3_EN, "TV_3V3_EN"))
		pr_err("failed to request gpio TV_3V3_EN\n");
}

static uint32_t lcdc_gpio_table[] = {
	GPIO_CFG(GPIO_TV_1V8_EN, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
	GPIO_CFG(GPIO_TV_2V5_EN, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
	GPIO_CFG(GPIO_TV_RST, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
	GPIO_CFG(GPIO_TV_3V3_EN,  0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), };
#else
static int gpio_array_num[] = {
...
MACHINE_START(SISA, "sisa ZTE handset")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io        = MSM_DEBUG_UART_PHYS,
	.io_pg_offst    = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
