/*
 * drivers/media/video/msm/mt9d115.c
 *
...
static int32_t mt9d115_set_brightness(int8_t brightness)
{
    ...
    switch (brightness)
    {
        ...
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[0],
                                         mt9d115_regs.brightness_tbl_sz[0]);
        }
        break;

        case CAMERA_BRIGHTNESS_1:
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[1],
                                         mt9d115_regs.brightness_tbl_sz[1]);
        }
        break;

        case CAMERA_BRIGHTNESS_2:
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[2],
                                         mt9d115_regs.brightness_tbl_sz[2]);
        }
        break;
        
        case CAMERA_BRIGHTNESS_3:
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[3],
                                         mt9d115_regs.brightness_tbl_sz[3]);
        }
        break; 

        case CAMERA_BRIGHTNESS_4:
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[4],
                                         mt9d115_regs.brightness_tbl_sz[4]);
        }
        break;
        
        case CAMERA_BRIGHTNESS_5:
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[5],
                                         mt9d115_regs.brightness_tbl_sz[5]);
        }
        break;
        
        case CAMERA_BRIGHTNESS_6:
        {
            rc = mt9d115_i2c_write_table(mt9d115_regs.brightness_tbl[6],
                                         mt9d115_regs.brightness_tbl_sz[6]);
        }        
        break;
...
static int32_t mt9d115_set_iso(int8_t iso_val)
{
    ...
    switch (iso_val)
    {
        case CAMERA_ISO_SET_AUTO:
        {
            ...
            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x0990, 0x008B, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }
...
static int32_t  mt9d115_set_antibanding(int8_t antibanding)
{
    ...
    switch (antibanding)
    {
        ...
        case CAMERA_ANTIBANDING_SET_60HZ:
        {
            ...
            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x0990, 0x00B0, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }  
        ...
        case CAMERA_ANTIBANDING_SET_50HZ:
        {
            ...
            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x0990, 0x00D0, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }  
        ...
        case CAMERA_ANTIBANDING_SET_AUTO:
        {
            ...
            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x0990, 0x0010, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }  
...
static long mt9d115_set_sensor_mode(int32_t mode)
{
    ...
    switch (mode)
    {
        ...
        {
            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x098C, 0x2707, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }

            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x0990, 0x0640, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }

            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x098C, 0x2709, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }

            rc = mt9d115_i2c_write(mt9d115_client->addr, 0x0990, 0x04B0, WORD_LEN);
            if (rc < 0)
            {
                return rc;
            }
