...
{
	// VCI=2.6V, IOVCC=1.8V
	HX8368_WriteReg(0x11); //Sleep Out
	msleep(120);
	...
	msleep(50);
	HX8368_WriteReg(0xBB);
	HX8368_WriteData(0X00);
	HX8368_WriteData(0X00);
	HX8368_WriteData(0X80);
	HX8368_WriteReg (0xEA); // For Himax internel use
	...
	HX8368_WriteData(0X5c);
	HX8368_WriteData(0X93);
	HX8368_WriteData(0X74);

	HX8368_WriteReg(0xE0);    // Set Gamma 
	HX8368_WriteData(0x0a);  
	HX8368_WriteData(0x11);  
	HX8368_WriteData(0x1b); 
	HX8368_WriteData(0x27); 
	HX8368_WriteData(0x27); 
	HX8368_WriteData(0x3F); 
	HX8368_WriteData(0x0a); 
	HX8368_WriteData(0x5b); 
	HX8368_WriteData(0x0e); 
	...
	HX8368_WriteData(0x18); 
	HX8368_WriteData(0x35); 
	HX8368_WriteData(0x34); 
	HX8368_WriteData(0x34); 
	HX8368_WriteData(0x24); 
	HX8368_WriteData(0x6f); 
	HX8368_WriteData(0x0e); 
	HX8368_WriteData(0x12); 
	HX8368_WriteData(0x1F); 
	HX8368_WriteData(0x19); 
	HX8368_WriteData(0x0c); 
	HX8368_WriteData(0xFF);
	msleep(50);
	HX8368_WriteReg(0x29); // Display On
	msleep(50);
	HX8368_WriteReg(0x2a);
	HX8368_WriteData(0X00);
	HX8368_WriteData(0X00); 
	HX8368_WriteData(0X01);
	HX8368_WriteData(0X3F);
	HX8368_WriteReg(0x2b);
	HX8368_WriteData(0X00);
	HX8368_WriteData(0X00); 
	HX8368_WriteData(0X00);
	HX8368_WriteData(0XEF);
